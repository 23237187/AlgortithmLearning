...
/**
 *  The <tt>yang.al.stdlib.StdIn</tt> class provides static methods for reading strings
 ...
 *  mask. If the input begins with the optional byte-order mask, <tt>yang.al.stdlib.StdIn</tt>
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to yang.al.stdlib.StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from In to yang.al.stdlib.StdIn */

    /*** begin: section (2 of 2) of code duplicated from In to yang.al.stdlib.StdIn,
    ...
    /*** end: section (2 of 2) of code duplicated from In to yang.al.stdlib.StdIn */


    // do this once when yang.al.stdlib.StdIn is initialized
    static {
        resync();
    }

    /**
     * If yang.al.stdlib.StdIn changes, use this to reinitialize the scanner.
     */
